...
<div class="form-inline mb-2">	
	<input type="text" class="form-control mr-1" id="sample4_postcode" name="postNo" readonly placeholder="우편번호">
...
<div class="form-row mb-2" id="postApiAddrDiv">
	<div class="col">
		<input type="text" class="form-control" readonly id="sample4_roadAddress" name="addr" placeholder="도로명주소">
	</div>
</div>
<div class="mb-2" id="postApiAddrDetailDiv" style="display: none">
	<input type="text" id="sample4_detailAddress" class="form-control" name="addrDetail" maxlength="50" placeholder="상세주소">
</div>
