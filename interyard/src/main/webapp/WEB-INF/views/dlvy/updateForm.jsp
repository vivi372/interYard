...
<form method="post" id="dlvyUpdateForm">
	...
	<div class="form-group">
		<label for="dlvyName">배송지 별명</label> 
		<select class="form-control w-50 mb-2" id="dlvyName" name="dlvyName">
		    <option>집</option>
		    <option>회사</option>
		    <option>학교</option>
		    <option>친구</option>
		...
		<input type="text" class="form-control" id="selfInput" maxlength="10" placeholder="배송지 별명을 입력해주세요">
	</div>
	<div class="form-group">
		<label for="recipient">받는 사람</label> 
		<input type="text" class="form-control" id="recipient" name="recipient" maxlength="10" value="${vo.recipient }">
	</div>
	<div class="form-group">
		<label for="phone">연락처</label> 
		<input type="text" class="form-control txtPhone" id="modalPhone" name="tel" value="${vo.tel }">
	</div>
	...
	<div class="custom-control custom-switch mb-3" id="basicDiv">
  	...
  	<div class="text-right">
		<button type="button" id="dlvyUpdateBtn" class="btn btn-dark">수정</button>	
	</div>
</form>