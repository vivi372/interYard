...
<form method="post" id="dlvyWriteForm">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" id="recipient" maxlength="10" name="recipient">
	</div>
	<div class="form-group">
		<label for="modalPhone">연락처</label> 
		<input type="text" class="form-control txtPhone" id="modalPhone" name="tel">
	</div>
	<div class="custom-control custom-switch mb-3" id="basicDiv">
  	...
  	<div class="text-right">
		<button type="button" id="dlvyWriteFormBtn" class="btn btn-dark">등록</button>	
	</div>
</form>