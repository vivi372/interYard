...
<script type="text/javascript">
	$(function() {
		...
		$("#perPageNum").val(
				"${(empty pageObject.perPageNum)?'15':pageObject.perPageNum}");
	});
</script>
								...
								<div class="input-group mb-3">
									<div class="input-group-prepend">
										<select name="key" id="key" class="form-control">
											<option value="ct">제목</option>
											<option value="cm">저자</option>
											<option value="cp">출판사</option>
										</select>
									</div>
									...
									<div class="card" style="width: 100%">
										...
										<div class="card-body">
											...
											<p class="card-text title">
												${vo.goodsMaker } 저, ${vo.goodsPublicher } <br>
												<b> 정가 : ${vo.goodsPrice }원 </b><br> ISBN : <span class="goodsNo">${vo.goodsNo}</span> <br>
