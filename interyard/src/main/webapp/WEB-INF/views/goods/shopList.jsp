	...
	$(function() {
		...
		$(".dataRow").click(
				function() {
					...
					location = "shopView.do?goodsNo=" + goodsNo
			...
			<main class="col-9 py-md-3 pl-md-5 bd-content" role="main">
				<div class="container">
	  			...
	  			${"<div class='row'>"}
									...
									<div class="card" style="width: 100%">
										...
										<div class="card-body">
											...
											<p class="card-text title">
												<b>${vo.goodsPrice }</b> 원<span class="goodsNo" data-goodsNo="${vo.goodsNo}"></span>
											</p>
										</div>
									</div>
								</div>
						...
						<!-- 페이지 네이션 처리 -->
						<div>
							<pageNav:pageNav listURI="shopList.do" pageObject="${pageObject }" />
						</div>

					</c:if>
					<c:if test="${login.gradeNo == 9 }">
						<!-- 리스트 데이터 표시의 끝 -->
						<a href="shopWriteForm.do?perPageNum=${pageObject.perPageNum }" class="btn btn-primary">등록</a>
					</c:if>
				</div>
			</main>
		</div>
