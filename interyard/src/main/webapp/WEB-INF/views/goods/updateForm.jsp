					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							<div class="form-group">
								...
								<input id="goodsSubTitle" name="goodsSubTitle" required value="${vo.goodsSubTitle }" class="form-control">
							</div>
							<div class="row">
								<div class="col-sm-3">
									<div class="form-group">
								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<input id="goodsTrans" name="goodsTrans" value="${vo.goodsTrans }" class="form-control">
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-sm-3">
									<div class="form-group">
										...
										<input id="goodsNo" name="goodsNo" required value="${vo.goodsNo }" class="form-control">
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input id="goodsPrice" name="goodsPrice" required value="${vo.goodsPrice }" class="form-control">
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="goodsStartDate">출판일</label>
										<input id="goodsStartDate" name="goodsStartDate" required value="${vo.goodsStartDate }" autocomplete="off"
